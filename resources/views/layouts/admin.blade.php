...
<aside id="sidebar">
    ...
    <nav class="flex-1 px-3 space-y-0.5 overflow-y-auto">
        ...
        <a href="{{ route('admin.eleves.index') }}"
           class="nav-link {{ request()->routeIs('admin.eleves.index') ? 'active' : 'text-navy-700 hover:bg-slate-50' }} flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-sm transition-colors">
        ...
        <div class="pt-3 mt-2 border-t border-slate-100">
            ...
            <a href="{{ route('admin.administrateurs.index') }}"
                ...
                <span class="lbl">Comptes et Accès</span>
                <span class="tip">Comptes et Accès</span>
            </a>
        </div>
        @endif
