...
<aside id="sidebar">
    ...
    <nav class="flex-1 px-3 space-y-0.5 overflow-y-auto">
        <a href="{{ route('eleve.dashboard') }}"
            class="nav-link {{ request()->routeIs('eleve.dashboard') ? 'active' : 'text-navy-700 hover:bg-slate-50' }} flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-sm transition-colors">
            <span class="material-symbols-outlined shrink-0">dashboard</span>
            <span class="lbl">Tableau de bord</span>
            <span class="tip">Tableau de bord</span>
        </a>
        <a href="{{ route('eleve.notes') }}"
            class="nav-link {{ request()->routeIs('eleve.notes') ? 'active' : 'text-navy-700 hover:bg-slate-50' }} flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-sm transition-colors">
        ...
        <a href="{{ route('eleve.bulletins') }}"
            class="nav-link {{ request()->routeIs('eleve.bulletins') ? 'active' : 'text-navy-700 hover:bg-slate-50' }} flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-sm transition-colors">
        ...
        <div class="pt-2 border-t border-slate-100">
            <a href="{{ route('eleve.profil') }}"
                class="nav-link {{ request()->routeIs('eleve.profil') ? 'active' : 'text-navy-700 hover:bg-slate-50' }} flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-sm transition-colors">
    ...
    <div class="p-4 border-t border-slate-100 shrink-0">
        <div class="flex items-center gap-3 p-2">
            ...
            <div class="user-info min-w-0">
                ...
                <p class="text-xs text-navy-700 truncate">Élève</p>
            </div>
        </div>
