                ...
                <div class="mt-3 flex items-center gap-2">
                    ...
                    @php
                        $statutConfig = match($suivi->statut) {
                            'a_jour'    => ['bg' => 'bg-emerald-100', 'text' => 'text-emerald-700', 'dot' => 'bg-emerald-500', 'label' => 'À jour'],
                            'partiel'   => ['bg' => 'bg-amber-100',   'text' => 'text-amber-700',   'dot' => 'bg-amber-500',   'label' => 'Partiel'],
